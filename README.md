...
可從 [GitHub Releases](https://github.com/ShiGaChenTW/txtnimal/releases) 下載 macOS Universal ZIP。V0.1.0 同時支援 Apple Silicon 與 Intel Mac。
...
Download the Universal macOS ZIP from [GitHub Releases](https://github.com/ShiGaChenTW/txtnimal/releases). V0.1.0 supports both Apple Silicon and Intel Macs.
